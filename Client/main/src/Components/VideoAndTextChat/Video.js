// Acknowledging https://github.com/0x5eba/Video-Meeting for the video conferencing code availability.
			...
			<div>
				{this.state.askForUsername === true ?
					<div>
						<div style={{background: "white", width: "30%", height: "auto", padding: "20px", minWidth: "400px",
								textAlign: "center", margin: "auto", marginTop: "50px", justifyContent: "center"}}>
							<p style={{ margin: 0, fontWeight: "bold", paddingRight: "50px" }}>Enter your name &#38; click on Connect</p>
							<Input required placeholder="Username" value={this.state.username} onChange={e => this.handleUsername(e)} />
							<Button variant="contained" color="primary" onClick={this.connect} style={{ margin: "20px" }}>Connect</Button>
							<br /><br />
							<p style={{ margin: 0, fontWeight: "bold", paddingRight: "50px" }}>Correct your sitting posture, smile &#9787; &#38; hop in!</p>
						</div>
						...
						<div className="container">
							...
							<Row id="main" className="flex-container" style={{ margin: 0, padding: 0 }}>
								<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
									...
									width: elms === 0 || elms === 1 ? "50%":"100%",height: "100%"}}></video>
							</Row>
						</div>
					</div>
				}
